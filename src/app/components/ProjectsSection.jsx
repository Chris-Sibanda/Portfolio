...
const ProjectsSection = () => {
  ...
  return (
    <section id="projects">
      <h2 className="text-start font-bold text-white mt-4 mb-4 text-2xl md:text-3xl lg:text-4xl">
        View My Projects
      </h2>
      <div className="text-white flex flex-row justify-start items-center gap-2 py-6 text-center">
        <ProjectTag
